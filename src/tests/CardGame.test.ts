...
let p0Info:PlayerInfo = {name: p0.name, id:p0.id, position:-1, isReady:false, leftTable:false}
let p1Info:PlayerInfo = {name: p1.name, id:p1.id, position:-1, isReady:false, leftTable:false}
let p2Info:PlayerInfo = {name: p2.name, id:p2.id, position:-1, isReady:false, leftTable:false}
let p3Info:PlayerInfo = {name: p3.name, id:p3.id, position:-1, isReady:false, leftTable:false}

let playersInfo:PlayerInfo[] = [p0Info, p1Info,p2Info, p3Info] //track info by player number
